...
이 스크립트를 돌리면 그 자리가 아래로 바뀐다.
    ...
    // ==PI-BEGIN== (자동 생성 — 고치지 말 것. tools/widgets/_pi_helper.js 를 고칠 것)
...
BEGIN = "// ==PI-BEGIN== (자동 생성 — 고치지 말 것. tools/widgets/_pi_helper.js 를 고칠 것)"
END = "// ==PI-END=="
MARK = "//%PI%"
...
def main():
    ...
    helper = (wdir / "_pi_helper.js").read_text(encoding="utf-8").rstrip("\n")
