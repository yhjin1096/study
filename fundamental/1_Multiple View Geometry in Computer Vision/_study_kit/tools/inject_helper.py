...
이 스크립트를 돌리면 그 자리가 아래로 바뀐다.
    ...
    // ==MV-BEGIN== (자동 생성 — 고치지 말 것. tools/widgets/_mv_helper.js 를 고칠 것)
    if (!window.MV) window.MV = (function () { ... })();
    // ==MV-END==
...
BEGIN = "// ==MV-BEGIN== (자동 생성 — 고치지 말 것. tools/widgets/_mv_helper.js 를 고칠 것)"
END = "// ==MV-END=="
MARK = "//%MV%"
...
def main():
    ...
    helper = (wdir / "_mv_helper.js").read_text(encoding="utf-8").rstrip("\n")
