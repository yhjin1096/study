...
이 스크립트를 돌리면 그 자리가 아래로 바뀐다.
    ...
    // ==IC-BEGIN== (자동 생성 — 고치지 말 것. tools/widgets/_ic_helper.js 를 고칠 것)
    if (!window.IC) window.IC = (function () { ... })();
    // ==IC-END==
...
BEGIN = "// ==IC-BEGIN== (자동 생성 — 고치지 말 것. tools/widgets/_ic_helper.js 를 고칠 것)"
END = "// ==IC-END=="
MARK = "//%IC%"
...
def main():
    ...
    helper = (wdir / "_ic_helper.js").read_text(encoding="utf-8").rstrip("\n")
