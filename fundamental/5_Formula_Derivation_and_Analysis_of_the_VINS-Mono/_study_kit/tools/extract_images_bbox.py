...
이 문서(VINS-Mono)에는 그림 캡션이 없다 — 전문에서 "Figure" 가 본문 안내로 1회 나올 뿐
번호 붙은 캡션이 하나도 없다. 그래서 캡션 기반인 extract_figures.py 를 쓸 수 없다.
그림 10개와 이미지 객체 10개가 1:1 로 대응하므로 bbox 를 그대로 clip 으로 삼는다. (페이지 전체를 덮는 스캔 이미지가 아니라
...
NAMES = {
    ( 2, 1): "fig01_p02_world_body_camera_frames",
    ( 3, 1): "fig02_p03_specific_force_in_body_frame",
    ( 3, 2): "fig03_p03_stationary_imu_reads_minus_gravity",
    ( 4, 1): "fig04_p04_imu_measurement_model",
    ( 5, 1): "fig05_p05_integration_with_world_reference",
    ( 6, 1): "fig06_p06_integration_with_bk_reference",
    ( 7, 1): "fig07_p07_preintegration_as_one_factor",
    ( 8, 1): "fig08_p08_midpoint_vs_euler_method",
    ( 9, 1): "fig09_p09_true_nominal_error_states",
    (13, 1): "fig10_p13_initialization_pipeline",
}
